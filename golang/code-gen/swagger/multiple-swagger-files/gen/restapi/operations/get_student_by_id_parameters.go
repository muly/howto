...
// GetStudentByIDParams contains all the bound params for the get student by ID operation
...
func (o *GetStudentByIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
