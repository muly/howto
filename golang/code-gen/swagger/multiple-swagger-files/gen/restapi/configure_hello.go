...
import (
	...
	"github.com/muly/howto/golang/code-gen/swagger/multiple-swagger-files/gen/restapi/operations"
)

//go:generate swagger generate server --target ../../gen --name Hello --spec ../../swagger/index.yaml --principal interface{} --exclude-main
