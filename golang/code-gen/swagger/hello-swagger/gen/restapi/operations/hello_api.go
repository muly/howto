...
func (o *HelloAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/api/students/{id}"] = NewGetStudentByID(o.context, o.GetStudentByIDHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/api/students"] = NewGetStudents(o.context, o.GetStudentsHandler)
}
