...
func configureAPI(api *operations.CustomersAPI) http.Handler {
	...
	if api.PostCustomerPostCustomerHandler == nil {
		api.PostCustomerPostCustomerHandler = post_customer.PostCustomerHandlerFunc(func(params post_customer.PostCustomerParams) middleware.Responder {
			return middleware.NotImplemented("operation post_customer.PostCustomer has not yet been implemented")
		})
	}
